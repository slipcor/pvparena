...
public class Config
{
    ...
    /**
     * Parse an input string of the form "x1,y1,z1,x2,y2,z2" and an input World to create
     * a Location array. This method will only accept strings of the specified form.
     * @param world the World in which the Locations exists 
     * @param coords a string of the form "x1,y1,z1,x2,y2,z2"
    ...
    public static Location[] parseCuboid(World world, String coords) {
        ...
        if (parts.length != 6)
            throw new IllegalArgumentException("Input string must contain only x1, y1, z1, x2, y2, and z2");
        ...
        Location[] l = {new Location(world, x1, y1, z1), new Location(world, x2, y2, z2)};
        return l;
        
    }
    
    /**
     * Parse an input string of the form "x,y,z" and an input World to create
     * a Location. This method will only accept strings of the specified form.
     * @param world the World in which the Location exists 
     * @param coords a string of the form "x,y,z"
     ...
     * specified form.
     * @param world the World in which the Location exists 
     * @param coords a string of the form "x,y,z,yaw,pitch"
     * @return a Location in the given world with the given coordinates
     */
